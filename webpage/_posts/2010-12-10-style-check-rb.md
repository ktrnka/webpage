...
date: 2010-12-10
---
I'm very interested in tools to help write papers, specifically automatic proofreaders.  I've noted a couple before, namely [After the Deadline](http://kwtrnka.wordpress.com/2010/10/22/after-the-deadline/ "After the Deadline") and [Grammarian Pro X](http://kwtrnka.wordpress.com/2010/11/23/grammarian-pro-x/ "Grammarian Pro X").  I recently came across the tool [style-check.rb](http://www.cs.umd.edu/~nspring/software/style-check-readme.html), which helps proofread LaTeX documents.  It doesn't really have a name per se, just the filename style-check.rb.
...
```
![style-check.rb on test-dirty.tex](http://kwtrnka.wordpress.com/wp-content/uploads/2010/12/screen-shot-2010-12-10-at-4-00-18-pm.png "style-check.rb on test-dirty.tex")
```
...
[![style-check.rb on test-dirty.tex with verbose output](http://kwtrnka.wordpress.com/wp-content/uploads/2010/12/screen-shot-2010-12-10-at-4-08-11-pm.png "style-check.rb on test-dirty.tex with verbose output")](http://kwtrnka.wordpress.com/wp-content/uploads/2010/12/screen-shot-2010-12-10-at-4-08-11-pm.png)
