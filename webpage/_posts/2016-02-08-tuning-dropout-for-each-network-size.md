...
[![Shallow NN hidden units on 50k dataset](https://kwtrnka.wordpress.com/wp-content/uploads/2016/02/shallow-nn-hidden-units-on-50k-dataset.png)](https://plot.ly/~keith.trnka/69/shallow-nn-hidden-units-on-50k-dataset/)
...
[caption id="attachment\_1488" align="alignnone" width="4818"][![Scaling number of units with and without dropout tuning on 50k dataset](https://kwtrnka.wordpress.com/wp-content/uploads/2016/02/scaling-number-of-units-with-and-without-dropout-tuning-on-50k-dataset.png)](https://plot.ly/~keith.trnka/87/scaling-number-of-units-with-and-without-dropout-tuning-on-50k-dataset/) The hidden layer config is shown on the x-axis as Python tuples; this graph is a series of experiments with different numbers of hidden units in a single hidden layer. This was run with 10-fold cross-validation and the following dropout values were tested: [0.4, 0.5, 0.6, 0.7, 0.8].[/caption]Now we see a different trend: when tuning dropout in conjunction with the network size, the added capacity doesn't lead to overfitting. If anything it improves accuracy slightly then plateaus.
...
[![he_uniform vs glorot_uniform across network size with and without dropout tuning](https://kwtrnka.wordpress.com/wp-content/uploads/2016/02/he_uniform-vs-glorot_uniform-across-network-size-with-and-without-dropout-tuning.png)](https://plot.ly/~keith.trnka/88/he-uniform-vs-glorot-uniform-across-network-size-with-and-without-dropout-tuning/)
