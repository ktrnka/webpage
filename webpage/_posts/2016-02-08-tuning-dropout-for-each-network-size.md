...
![Scaling number of units with and without dropout tuning on 50k dataset](/assets/img/posts/wp/scaling-number-of-units-with-and-without-dropout-tuning-on-50k-dataset.png)
