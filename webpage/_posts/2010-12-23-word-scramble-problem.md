...
* The comments have some excellent points
  ...
  + rastafasta links an excellent [youtube response](https://www.youtube.com/watch?v=TNStNUizxhE).  It gives a more realistic assessment of things.
* In all likelihood, it might be best to suggest that a [noisy channel model](https://en.wikipedia.org/wiki/Noisy_channel_model) of typing/etc is what's going on.  Here are some examples of related things:
  + email/paper typos
