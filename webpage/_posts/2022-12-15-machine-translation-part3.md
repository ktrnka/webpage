...
[Last time I posted]({% post_url 2022-11-18-machine-translation-for-medical-chat-checkpoint-2 %}), I was prototyping different user interfaces for machine translation-mediated chat and hit a wall. Since then I've been reading papers to get ideas. I read papers already in my queue, explored the citation graph around those papers, and I also tried [Elicit](https://elicit.org/) to expand my search more.
