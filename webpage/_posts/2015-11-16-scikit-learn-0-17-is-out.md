...
In [the previous post](/blog/2015/11/progress-is-slow/) I described possible directions to get from 67.9% accuracy up to 70.0% and suggested that an ensemble of the best classifiers may be a fruitful direction but may take a bit of time to code.
