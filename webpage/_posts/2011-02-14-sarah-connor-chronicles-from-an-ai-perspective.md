...
* When chasing John, Chromartie switches to infrared at some point.  Realistically, a good machine would use both visible spectrum and IR at the same time.
  + For reference in the real world, see [DoDaam's Super aEgis II](https://newatlas.com/korea-dodamm-super-aegis-autonomos-robot-gun-turret/17198/), which is an autonomous turret that "can find and lock on to a human-sized target in pitch darkness at a distance of up to 1.36 miles".
