...
Last week I mentioned that I was working to [restore the capitalization]({{ "/blog/2011/01/title-case-pos-tagging-nnp/" | relative_url }} "title case + pos tagging = nnp") of graph titles.  At the time, I was using Google's trillion word unigram model to disambiguate case.  But it didn't work quite right.  It seemed like an improvement over just lowercasing them, but you'd end up with words like *Spring* or *Jobs* capitalized all the time.  It became clear that some additional information was necessary.  There are three candidates for additional information:
