...
![Accuracy vs network configuration](/assets/img/posts/wp/accuracy-vs-network-configuration.png)
...
![Accuracy vs dropout](/assets/img/posts/wp/accuracy-vs-dropout.png)
...
![Batch spec ((100, 1024), (100, -1)) means 100 epochs in batches of 1024 followed by 100 epochs in matches of max size (full batch).](/assets/img/posts/wp/accuracy-vs-training-iterations.png)
...
![Accuracy with and without early stopping](/assets/img/posts/wp/accuracy-with-and-without-early-stopping.png)
