...
I rarely get the time to implement a feature request, but I've taken a step to help:  [ParseTreeApplication is now on Github](https://github.com/ktrnka/ParseTreeApplication)!  You can download the source and build it in [Eclipse](http://www.eclipse.org) without much trouble.  Also, I've added some examples of how you can use the ParseTreePanel in an external Java application/applet under [src/edu/udel/ktrnka/pta/examples](https://github.com/ktrnka/ParseTreeApplication/tree/master/src/edu/udel/trnka/pta/examples).
